...
export default function FoodHandlerScreen({navigation,route}) {
    const docTitle = "Food Handler's License"
    ...
    return (   
        <SafeAreaView style={globalStyles.safe_light}>
            <View style={[globalStyles.page,{paddingTop:70}]}>
                ...
                :   
                    <TouchableOpacity style={styles.upload_btn} onPress={() => loadDoc()}  >
